...
public class MyScheduleActivity extends AppCompatActivity {
    ...
    static HashSet<String> uch_plan_set;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] uch_plan = getIntent().getStringExtra("uch_plan").split(" ");
        uch_plan_set = new HashSet<>();
        Collections.addAll(uch_plan_set, uch_plan);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            ListView my_subjectsList = (ListView) rootView.findViewById(R.id.my_subjectsList);
            ...
            for (String lesson : subjects_array[index]) {
                Set<String> subjects_set_for_lesson = new HashSet<>();
                Collections.addAll(subjects_set_for_lesson, lesson.split(" "));
                HashSet<String> t_uch_plan_set = (HashSet<String>) uch_plan_set.clone();
                t_uch_plan_set.retainAll(subjects_set_for_lesson);
                if (t_uch_plan_set.size() == 0)
                    new_list.add("");
                else
                    new_list.add(TextUtils.join(" ", t_uch_plan_set));
            }
            subjects_array[index] = new_list.toArray(new String[new_list.size()]);

            my_subjectsList.setAdapter(new ArrayAdapter<String>(getContext(), android.R.layout.simple_list_item_1, subjects_array[index]));
            return rootView;
        }
    }
